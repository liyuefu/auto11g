...
unzip /stage/p6880880_112000_Linux-x86-64.zip
...
cd /stage/patch/144;unzip /stage/p14407401_112040_Generic.zip
...
cd /stage/patch/168;unzip /stage/p16811897_112040_Generic.zip
...
cd /stage/patch
unzip /stage/p31537677_112040_*.zip
#cd 31537677 
